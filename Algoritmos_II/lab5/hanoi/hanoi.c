...
/*
    Complete the following recursive function. Use the python's solution as a guide:
    https://en.wikipedia.org/wiki/Tower_of_Hanoi
    Watch incomplete code below.

    The other functions are already complete.

*/

// Function delay for the output "good view".
...
static void move(unsigned int current,
    hanoi_t hanoi,
    stack_t *source_ptr, // Tower A
    stack_t *target_ptr, // Tower C
    stack_t *aux_ptr     // Tower B
    ) {
	delay(3);
	printf("\033[2J"); // Printing ASCII code to use only one screen.
	if ( current > 0 ) {
