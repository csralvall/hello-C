...
hay_caminoG v w Vacío = False
hay_caminoG v w (Arista a b g) | v == a = (hay_caminoG b w g) || (hay_caminoG v w g)
			       | otherwise = hay_caminoG v w g || ((hay_caminoG v a g) && (hay_caminoG b w g))
